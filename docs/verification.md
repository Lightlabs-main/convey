...
Status: **account-abstraction gate passed on X Layer mainnet.** One sponsored UserOperation deployed the selected receiver account and completed successfully. Product contracts can now proceed; claim-gas accounting and receiver recovery remain separate verification work.
