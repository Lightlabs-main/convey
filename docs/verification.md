...
Status: **account-abstraction gate passed on X Layer mainnet.** One sponsored UserOperation deployed the selected receiver account and completed successfully. The product registry, escrow, and claim paymaster are deployed and funded; the first private product claim reached inclusion but failed internally and was reclaimed, so a successful claim and receiver recovery remain separate verification work.
