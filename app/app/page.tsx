  ...
  return (
    <main className="page app-page">
      ...
      <section className="app-intro">
        ...
        <h1>Gift an <span className="gradient-text">xStock</span>.</h1>
        <p className="section-copy">Fund a gift from OKX Wallet. Your recipient claims it gasless with a passkey.</p>
        <a className="text-link hero-received" href="/#recurring">Want to gift a stock every month? The Convey Agent delivers recurring gifts →</a>
        <a className="text-link hero-received" href="/#agents" style={{ marginLeft: 24 }}>Using your own AI agent? Connect the Convey MCP server →</a>
